...
class VisorImagenes:
    ...
    def open_image_file(self) -> None:
        ...
        if not path:
            return
        self.set_image_list_and_load([path])
    ...
    def browse_file(self) -> None:
        ...
        if not path_list:
            return
        self.set_image_list_and_load(path_list)
    ...
    def set_image_list_and_load(self, paths: list[str]) -> None:
        """
        Configura la lista de imágenes y carga la primera.
        ...
        self.file_path_var.set(self.image_paths[0])
    ...
    def open_image_folder(self) -> None:
        ...
        if not paths:
            ...
            return
        self.set_image_list_and_load(paths)

    def reset_edit_state(self) -> None:
        """
        Restablece todos los controles de edición a sus valores por defecto.
        """
